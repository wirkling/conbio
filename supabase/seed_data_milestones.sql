...
BEGIN
  ...
  IF psoriasis_id IS NOT NULL THEN
    ...
    INSERT INTO contracts (
      ...
      '2024-02-15', '2024-03-01', '2026-10-31',
      285000, 'EUR', 'operations',
    ...
    INSERT INTO contracts (
      ...
      '2024-03-01', '2024-04-01', '2026-11-30',
      135000, 'EUR', 'operations',
    ...
    INSERT INTO contracts (
      ...
      '2024-01-20', '2024-02-01', '2024-06-30',
      42000, 'EUR', 'operations',
  ...
  IF wound_study_id IS NOT NULL THEN
    ...
    INSERT INTO contracts (
      ...
      '2025-01-25', '2025-02-15', '2026-10-31',
      95000, 'EUR', 'operations',
